...
Use this reference when the user asks to write into Obsidian, the `文献库` vault, or a paper-note folder inside the vault.
...
- Short concept or material entries derived from repeated terms: `材料知识库/`
