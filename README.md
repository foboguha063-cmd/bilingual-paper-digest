...
`bilingual-paper-digest` 是一个面向用户固定文献笔记格式的中英文双语整理 skill。它把 PDF、DOI、论文正文或补充材料整理为紧凑的 Markdown 文献笔记，而不是全文 reader、摘要或图文提取包。
...
除非用户明确要求，该 skill 不整理图片、图表、图注、表格正文、Glossary、致谢、作者贡献、利益冲突、出版商声明或完整参考文献列表。
